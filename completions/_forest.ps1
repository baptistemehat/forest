...
Register-ArgumentCompleter -Native -CommandName 'forest' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        ...
        'forest;report' {
            [CompletionResult]::new('-f', '-f', [CompletionResultType]::ParameterName, 'Report recorded time from a specific date time Defaults to ...')
            [CompletionResult]::new('--from', '--from', [CompletionResultType]::ParameterName, 'Report recorded time from a specific date time Defaults to ...')
            [CompletionResult]::new('-t', '-t', [CompletionResultType]::ParameterName, 'Report recorded time to a specific date time Defaults to now')
            [CompletionResult]::new('--to', '--to', [CompletionResultType]::ParameterName, 'Report recorded time to a specific date time Defaults to now')
            [CompletionResult]::new('-d', '-d', [CompletionResultType]::ParameterName, 'Report recorded time for the current day')
            [CompletionResult]::new('--day', '--day', [CompletionResultType]::ParameterName, 'Report recorded time for the current day')
            [CompletionResult]::new('-w', '-w', [CompletionResultType]::ParameterName, 'Report recorded time for the current week')
            [CompletionResult]::new('--week', '--week', [CompletionResultType]::ParameterName, 'Report recorded time for the current week')
            [CompletionResult]::new('-m', '-m', [CompletionResultType]::ParameterName, 'Report recorded time for the current month')
            [CompletionResult]::new('--month', '--month', [CompletionResultType]::ParameterName, 'Report recorded time for the current month')
            [CompletionResult]::new('-y', '-y', [CompletionResultType]::ParameterName, 'Report recorded time for the current year')
            [CompletionResult]::new('--year', '--year', [CompletionResultType]::ParameterName, 'Report recorded time for the current year')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            break
        }
